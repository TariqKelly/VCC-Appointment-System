...
def display_appointment():
    ...
    # Search Button
    search = Button(master, text="Search Appointments", width=25, height=2, command=search_db)
...
def update_appointment():
    ...
    update_appointment_window.geometry("2500x2500")
    ...
    # Search Button
    search = Button(master, text="Search Appointment Database", width=25, height=2, command=search_db)
    search.grid(row=3, columnspan=2, padx=10, pady=10)
...
# Delete Patient Button
remind_patient_button = Button(text="Remind Patient",width=30,command=remind_patient)
remind_patient_button.grid(row=9, columnspan=2, padx=10, pady=10, ipadx=30, ipady=20)
